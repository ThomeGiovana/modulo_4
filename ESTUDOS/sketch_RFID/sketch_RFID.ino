...
void setup() {
  ...
  Serial.println(MISO);//Descobrir pino MISO
  Serial.println(MOSI);//Descobrir pino MOSI
  Serial.println(SCK);//Descobrir pino SCK
...
void loop()
{
  //Serial.println("Leitura1:"+mfrc522.read());
